...
//                            x = 0;
    ...
    public boolean onBackPressed() {
        String titler = videoInfo.getTitle();
        SharedPreferences resumepref = context.getSharedPreferences(titler,context.MODE_PRIVATE);
        SharedPreferences.Editor editor = resumepref.edit();
        editor.putInt(titler, this.getCurrentPosition());
        editor.commit();
        log("onBackPressed");
    ...
    public static void play(Context context, VideoInfo videoInfo) {
        //DefaultMediaController controller = new DefaultMediaController(context);
        //controller.$.id(R.id.resume).visible();
