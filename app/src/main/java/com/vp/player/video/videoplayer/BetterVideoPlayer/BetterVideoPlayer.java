...
public class BetterVideoPlayer extends RelativeLayout implements IUserMethods,
    ...
    @Override
    public void setButtonDrawable(@LoadingStyle int type,
    ...
    protected void onFinishInflate() {
        ...
        mPositionTextView.setShadowLayer(1, 1, 1, Color.BLACK);
    ...
    OnSwipeTouchListener clickFrameSwipeListener = new OnSwipeTouchListener() {
        ...
        public void onMove(Direction dir, float diff) {
            ...
            if (dir == Direction.LEFT || dir == Direction.RIGHT) {
                ...
                mPositionTextView.setCompoundDrawablesWithIntrinsicBounds(0,0,0,0);
            } else {
                finalTime = -1;
                if (initialX >= mInitialTextureWidth / 2 || mWindow == null) {
                    ...
                    mPositionTextView.setText(progressText);
                    mPositionTextView.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_volume_up_white_36dp,0,0,0);
                    ...
                    mPositionTextView.setText(progressText);
                    mPositionTextView.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_brightness_6_white_36dp,0,0,0);
