...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> {
    ...
    public MusicAdapter(Fragment context, ArrayList<DataModel2> data) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v == itemView) {
                ((MusicFragment) context).onItemClicked(data.get(getLayoutPosition()));
                ...
                ((MusicFragment)context).addRemove(data.get(getLayoutPosition()));
