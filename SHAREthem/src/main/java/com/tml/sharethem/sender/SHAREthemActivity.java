...
public class SHAREthemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connecteds = (RelativeLayout) findViewById(R.id.connected);
        ...
        ImageView rocketImage = (ImageView) findViewById(R.id.VideoView01);
        rocketImage.setBackgroundResource(R.drawable.radar);
    ...
    private void addReceiverListItem(HotspotControl.WifiScanResult wifiScanResult) {
        ...
        connecteds.setVisibility(View.GONE);
