...
public class ReceiverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tohide1 =(TextView) findViewById(R.id.infotext);
        tohide2 =(ImageView) findViewById(R.id.priest);
        tohide3 =(ImageView) findViewById(R.id.rev);

        tohide3.setVisibility(View.VISIBLE);
